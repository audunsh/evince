...
var BraketModel = widgets.DOMWidgetModel.extend({
...
var BraketView = widgets.DOMWidgetView.extend({
    render: function() {
		console.log("Hello from BraketView 3.1");
        ...
        this.renderer.setSize( .9*document.activeElement.clientWidth, .9*document.activeElement.clientWidth*.6);
